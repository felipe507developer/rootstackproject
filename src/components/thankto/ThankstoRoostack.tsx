...
function ThankstoRoostack() {
  return (
    <section className=" grow bg-gray-50 text-black">
      <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-4 sm:text-xl sm:leading-relaxed">
            ...
            quiero agradecerles por el tiempo, la paciencia, y las motivacion
            por enseñarnos el funcionamiento del framework NextJs. Gracias a los
            jovenes Hector, Leonardo, Luis, Daniel, y a la señorita Alejandra
            por hacer el curso porsible.
          </p>
